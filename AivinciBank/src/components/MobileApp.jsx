...
const MobileApp = () => {
  ...
  return (
    <section ref={sectionRef} className="py-20 relative overflow-hidden">
      {/* Background gradient */}
      <div
        className="absolute inset-0 bg-gradient-to-b from-transparent via-10% to-transparent"
        style={{
          background: darkMode
        ...
        <div className="flex flex-col lg:flex-row items-center">
          ...
          >
            ...
            >
              ...
              <a
                href="#"
                className="flex items-center transition-all duration-500 ease-in-out py-3 px-4 rounded-3xl ml-5"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="40"
            ...
            <div className="relative border-8 rounded-[52px] border-black shadow-2xl shadow-amber-50">
              ...
              <div className="w-[280px] h-[580px] bg-[#111611] rounded-[40px] py-1 shadow-2xl relative overflow-hidden">
                ...
                <div className="w-full h-full rounded-[32px] overflow-hidden relative bg-gradient-to-b from-primary/20 to-primary/5">
                  {/* Status Bar */}
                  <div
                    className={`h-12 px-4 flex justify-between items-center ${
